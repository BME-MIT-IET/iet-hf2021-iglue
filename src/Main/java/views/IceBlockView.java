...
public class IceBlockView implements IView {
    ...
    public IceBlockView(IceBlock i){
        iceBlock = i;
        try {
            imagewithoutsnow =  ImageIO.read(new File("src/main/resources/iceblock.png"));
            imagewithsnow = ImageIO.read(new File("src/main/resources/snow.png"));
            tentcoverimage = ImageIO.read(new File("src/main/resources/tentCover.png"));
            igloocoverimage = ImageIO.read(new File("src/main/resources/igloo.png"));
        } catch (IOException e) {
